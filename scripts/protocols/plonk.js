...
class PlonkProtocol extends BaseProtocol {
    constructor() {
        super('plonk');
    }
    ...
    async setup(circuit, params) {
        ...
        this.executeCommand(`npx snarkjs plonk setup ${r1csPath} ${ptauPath} ${zkeyPath}`);
    ...
    async generateProof(circuit, params) {
        ...
        this.executeCommand(`npx snarkjs plonk prove ${zkeyPath} ${witnessPath} ${proofPath} ${publicPath}`);
    ...
    async verify(circuit, params) {
        ...
        const isValid = this.executeCommand(`npx snarkjs plonk verify ${vkeyPath} ${publicPath} ${proofPath}`);
