...
class FflonkProtocol extends BaseProtocol {
    constructor() {
        super('fflonk');
    }
    ...
    async setup(circuit, params) {
        ...
        this.executeCommand(`npx snarkjs fflonk setup ${r1csPath} ${ptauPath} ${zkeyPath}`);
    ...
    async generateProof(circuit, params) {
        ...
        this.executeCommand(`npx snarkjs fflonk prove ${zkeyPath} ${witnessPath} ${proofPath} ${publicPath}`);
    ...
    async verify(circuit, params) {
        ...
        const isValid = this.executeCommand(`npx snarkjs fflonk verify ${vkeyPath} ${publicPath} ${proofPath}`);
